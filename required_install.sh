...
sudo pacman -Syyu bat lsd vim shred wget curl nano jdk8-openjdk jdk11-openjdk jdk17-openjdk jdk-openjdk groovy texstudio texlive eza chafa lesspipe fzf fastfetch graphviz nerd-fonts logrotate --noconfirm

## Creación de carpetas
mkdir $HOME/app
mdkir $HOME/app/jvm
mdkir $HOME/app/grails
...
# Grails 2.5.5
wget -P ~/app/grails/ https://github.com/grails/grails-core/releases/download/v2.5.5/grails-2.5.5.zip
unzip grails-2.5.5.zip

# Grails 3.3.11
wget -P ~/app/grails/ https://github.com/grails/grails-core/releases/download/v3.3.11/grails-3.3.11.zip
unzip grails-3.3.11.zip

# Grails 4.0.10
wget -P ~/app/grails/ https://github.com/grails/grails-core/releases/download/v4.0.10/grails-4.0.10.zip
unzip grails-4.0.10.zip

# Grails 5.2.4
wget -P ~/app/grails/ https://github.com/grails/grails-core/releases/download/v5.2.5/grails-5.2.5.zip
unzip grails-5.2.5.zip

# Grails 6.2.0
wget -P ~/app/grails/ https://github.com/grails/grails-core/releases/download/v6.2.0/grails-6.2.0.zip
unzip grails-6.2.0.zip
